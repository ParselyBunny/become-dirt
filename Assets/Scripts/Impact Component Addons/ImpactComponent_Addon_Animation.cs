...
public class ImpactComponent_Addon_Animation : JTools.ImpactComponent_Addon
{
    ...
    public override void ComponentLateUpdate(JTools.ImpactController player)
    {
        ...
        {
            if (player.motionComponent.crouchMode != JTools.ImpactMotion_CrouchSetting.none && playerAnimator != null && crouchingWeight != string.Empty)
