...
Recently, though, he's been afraid of something. I don't know what he's worried about, but he always seems anxious and uneasy these days. My grandmother wants to make sure he knew all the family's magic so that he can pass it on one day, and he's been making great progress. I don't know what would make him so frightened... I should check on him today.
    ...
    ->RecollectionA
        ...
        SISTER: I...
        The truth is, I don't put any effort into things like that. Sometimes I write something really generic like, I'd like to be a receptionist at a dentist's office. I'd like to be an office worker at one of the banks downtown. I don't really want either of those things but I don't have any other ideas either, and those answers always satisfy the teachers so it works out for the best that way.
        SISTER: I usually write something practical. It's the future so it'll probably change a lot, and it's not like we really know what jobs will hire us or how long we'll be able to stay. 
        BROTHER: My teacher told me that we should write our report about what we think our future job will be, and then look up what people with that job do. It can't be a job anyone in our family has either, since we already did a family interview paper six weeks ago.     
        
        BROTHER: Mom's got two right now and I don't think either of them are things she wrote down 
...
=== GateOne
    ...
    =BrotherConvoA
        ...
        BROTHER: I’m not here I’m not here I’m not here I’m not here I’m not here I’m not here.
        SISTER: I know I’m stupid and I don’t know how to do any of the stuff you can do, but I’m still your big sister… I should be able to do something. I can’t do much but I should be able to do something to help.
...
---This is old... It's one of the books my grandmother's great-grandmother wrote.
->GateThree
=== GateThree
...
=== Explorations
    ...
    *Explore Crawl Space
    ...
    =MotherRoomExplore
        ->Explorations    
    =SiblingRoomExplore
        The bunk bed where my brother and I sleep. The bottom bunk is his, since I kept banging my head on the top bunk when I used to sleep down there. He asked me to switch one day, saying he was scared of heights and wanted to be closer to the ground. I'm pretty sure he was just being kind.
    
        A faded copy of Northanger Abbey rests under a pile of overstretched hair ties and flavored chapstick. 
        
        When I was seven I ruined my dresser with glitter stickers, so now the handles are covered in sticky dust and gunk. I thought I learned a really valuable lesson the day Mom yelled at me and made me scrape the stickers off one by one, but yesterday I scratched the varnish trying to open the top drawer. 
        ->Explorations
    =HallExplore
...
TODO Recall Conversation with brother that hints at his prior state of mind
TODO Mother Arrival and Chore Assignment 
TODO Use of BECOME VIGILANT and Eldest Daughter inner monologue where she doesn't consider it a "real" spell because it's not one of the three their family knows.
TODO Various exploration text for objects/interactions throughout the house
TODO tooltip text for BECOME DIRT
TODO tooltip text for BECOME VIGILANT
TODO tooltip text for BECOME GLASS
TODO tooltip text for BECOME MECHANICAL
TODO Dialogue Exchange(s) in Crawl Space
TODO Brother's School Writing practicing a spell
TODO Learn about family's past magic - Gives idea for how to use BECOME MECHANICAL in a way different than the grandmother conveys it.
TODO Escalation and new recollection from brother, arrive at crawl space with all four abilities and initiate finale
TODO Finale conversations & text
